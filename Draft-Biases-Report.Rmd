...
Teams are awarded draft picks based on a **draft lottery**, since 2023, with the
...
status, we created a barplot showing the percent of draftees by
...
```{r barplot, fig.align='center', fig.cap="Percentage of Players by Round and School Level", warning=FALSE}
...
```{r piechart, fig.cap="Pie Chart of Draftees MLB Status", out.height="80%", out.width="80%",fig.align = 'center'}
...
with the idea of creating an ordinal categorical (factor) variable named
...
because an accuracy of 78.32% is considered a "moderately accurate"
...
who will perform below average (as seen by 0.991 Sensitivity and 0.767
